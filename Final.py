...
display("first", firstcol)
display("second", secondcol)
display("third", thirdcol)
display("fourth", fourthcol)

def graph(string, datas):
    plot.hist(datas)
    plot.grid(True)
    plot.title(string)
    plot.show()
...
graph("Sepal Length", firstcol)
graph("Sepal Width", secondcol)
graph("Petal Length", thirdcol)
graph("Petal Width", fourthcol)
